    ...
    <div className="min-h-screen bg-[#F4F7F5] dark:bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12 flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-64 flex-shrink-0">
          <div className="bg-[#E6F4EA] dark:bg-[#064E3B] rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-[#E2E8F0] dark:border-[#065F46] overflow-hidden sticky top-28">
            <div className="p-6 text-center border-b border-[#E2E8F0] dark:border-[#065F46]">
        ...
        <div className="flex-1 space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {statsCards.map((stat, i) => (
              <motion.div
                ...
                className="bg-[#E6F4EA] dark:bg-[#064E3B] p-5 rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-[#E2E8F0] dark:border-[#065F46] flex items-center gap-4"
              >
          ...
          {/* Resumes Section */}
          <div className="bg-[#E6F4EA] dark:bg-[#064E3B] rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-[#E2E8F0] dark:border-[#065F46] overflow-hidden">
            <div className="p-6 border-b border-[#E2E8F0] dark:border-[#065F46] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <h2 className="text-xl font-bold text-[#0F172A] dark:text-white font-['Outfit'] flex items-center gap-2">
                <FileText className="w-5 h-5 text-[#10B981]" />
                My Resumes
              </h2>
              
              <div className="flex bg-[#F4F7F5] dark:bg-[#065F46] p-1 rounded-lg border border-[#E2E8F0] dark:border-transparent">
                <button 
                ...
                {mockResumes.map((resume, i) => {
                  ...
                  return (
                    <motion.div 
                      ...
                      transition={{ delay: i * 0.1 }}
                      className="group border border-[#E2E8F0] dark:border-[#065F46] rounded-3xl overflow-hidden bg-[#F4F7F5] dark:bg-[#064E3B] hover:shadow-[0_15px_30px_rgba(0,0,0,0.08)] transition-all hover:border-[#10B981] dark:hover:border-[#10B981]/50 flex flex-col h-64 relative"
                    >
                      {/* Thumbnail Area */}
                      ...
                      {/* Details */}
                      <div className="p-4 flex-1 flex flex-col justify-between bg-transparent dark:bg-transparent relative z-10">
                        <div>
